...
func (c *Config) forkBlockNumbers() []forkBlockNumber {
	return []forkBlockNumber{
		...
		{name: "planckBlock", blockNumber: c.PlanckBlock, optional: true},
		{name: "lubanBlock", blockNumber: c.LubanBlock, optional: true},
		{name: "platoBlock", blockNumber: c.PlatoBlock, optional: true},
